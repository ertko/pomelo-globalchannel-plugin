...
GlobalChannelManager.prototype.getSidByUid = function(name, uid, cb) {
  this.redis.hget(genChannelServerMapKey(this, name), uid, function(err, sid) {
    utils.invokeCallback(cb, err, sid);
  });
};
